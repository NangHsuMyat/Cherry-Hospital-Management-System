   ...
   <!-- Navbar Start -->
    ...
    <div class="container-fluid pt-5">
        <div class="container">
            ...
            <form action="SearchByName_Action.jsp" method="get">
            <div class="mx-auto" style="width: 100%; max-width: 600px;">
                <div class="input-group">
                   <input type="text" class="form-control border-primary w-50"  name="searchbyName" placeholder="Search with Doctor's name">
                    <button class="btn btn-dark border-0 w-25">Search</button>
                </div>
            </div><br><br></form>
            <form action="SearchBySpecialist" method="get">
            <div class="mx-auto" style="width: 100%; max-width: 600px;">
                <div class="input-group">
                    
                    <input type="text" class="form-control border-primary w-50" placeholder="Search with Doctor's Speciality">
                    <button class="btn btn-dark border-0 w-25" id="searchbySpecialist" >Search</button>
                </div>
            </div>
            </form>
        </div>
                    ...
                    <div class="row g-0 bg-light rounded overflow-hidden">
                        ...
                        <div class="col-12 col-sm-7 h-100 d-flex flex-column">
                            <div class="mt-0 p-4">
                                ...
                                <p class="m-0"> M.B, B.S, M.Med.Sc(Int. Medicine)</p>
                                <p class="m-0"> Dr.Med.Sc(Liver Specialist)</p>
                                
                                <table style="margin-top:20px;">
                                <tr><td style="width:100px;">Mon-Wed</td><td>10:00AM-12:00PM</td></tr>
                                <tr><td style="width:100px;">Thu-Fri</td><td>1:00PM-4:00PM</td></tr>
                                </table>
                        ...
                        <div class="col-12 col-sm-7 h-100 d-flex flex-column">
                            <div class="mt-0 p-4">
                               <h3>Dr.Soe Lwin</h3>
                                ...
                                <p class="m-0">M.B, B.S, MMed.Sc(Ortho)</p>
                        ...
                        <div class="col-12 col-sm-7 h-100 d-flex flex-column">
                            <div class="mt-0 p-4">
                               <h3>Dr.Khaing Yin Mon</h3>
                                ...
                                <p class="m-0">M.B, B.S, MMed.Sc(OG)</p>
                    ...
                    <div class="row g-0 bg-light rounded overflow-hidden">
                        ...
                        <div class="col-12 col-sm-7 h-100 d-flex flex-column">
                            <div class="mt-0 p-4">
                                ...
                                <p class="m-0">M.B, B.S, BDS, PhD(Tokyo)</p>

...
<%
    ...
    List<Doctors> list = DoctorDao.getDoctorsbyID(id);
...
<head>
<meta charset="utf-8">
<title>CHERRY - Update Doctor</title>
...
<div class="form-container">
    <h1>Update Doctor Registration</h1>

    <form action="Update_Action.jsp" method="post">
        <c:forEach items="${list}" var="r">
            <div class="form-floating mb-3">
                <input type="text" id="dname" name="dname" class="form-control" value="${r.getDname()}" placeholder="Doctor Name" required>
                <label for="dname">Doctor Name</label>
            </div>

            <div class="form-floating mb-3">
                <input type="text" id="dspecialist" name="dspecialist" class="form-control" value="${r.getDspecialist()}" placeholder="Doctor Specialize" required>
                <label for="dspecialist">Doctor Specialize</label>
            </div>

            <div class="form-floating mb-3">
                <input type="text" id="ddegree" name="ddegree" class="form-control" value="${r.getDdegree()}" placeholder="Doctor Degree" required>
                <label for="ddegree">Doctor Degree</label>
            </div>

            <div class="form-floating mb-4">
                <input type="text" id="dschedule" name="dschedule" class="form-control" value="${r.getDschedule()}" placeholder="Doctor Schedule" required>
                <label for="dschedule">Doctor Schedule</label>
            </div>

            <input type="hidden" name="did" value="${r.getDid()}">
            <button type="submit" class="turquoise-btn">Update Doctor Information</button>
        </c:forEach>
    </form>
</div>
